...
### Part 1: Branch & Directory Scaffolding
  ...
  * **([Repo Admin])**
    **NOTE:** This depends on the PR from the ICEX05 has been merged to main. 
...
### Part 2: Establish the Safety Net (Green ✅)

  * **([Dev Crew])** ONE MEMBER ONLY
...
### Part 3: The "Fire Drill" (Get to Red ❌)
  ...
  * **([Dev Crew])** ONE MEMBER ONLY (DIIFFERENT FROM PART 2)
