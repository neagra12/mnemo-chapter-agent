Here is the TA guide for the in-class exercise that follows Lecture 7.

---

# TA Guide: ICE 11 "Admin Powers & Inheritance" (Joke Admin)
...
1.  **Repo Admin:**
    ...
    * Remembers to `pip install click` (or just `Flask`) and `pip freeze > requirements.txt`.
