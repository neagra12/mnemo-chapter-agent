# Session log for the assignment to go with lecture 8 - Refactor admin decorator

## **---- PROMPT ----**
```markdown
Looks good. Let's see the assignment.
```

Here is the full write-up for **Homework 7 (mod2\_A12)**.

This assignment is the capstone for our "Internal Security / RBAC" sprint. It's a classic, professional-level refactoring task that teaches one of the most powerful features in Python: decorators.

-----

### Homework 7: The "@admin\_required" Decorator (A12)
