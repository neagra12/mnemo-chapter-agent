...
Yes, we are ready to move to **Lecture 12**.

This is the second lecture of **Cycle 3: Deployment & Services**.

**Context:** In Lecture 11, students containerized their own app ("The Web Service").
**Goal for Lecture 12:** Now, we introduce a *second* service ("The AI Rater"). The goal is to teach **service-to-service communication** within a Docker network.

**The "AI" Constraint:** Since downloading a real LLM (like Llama-2) takes too long for class, we will use a **"Mock AI" Microservice**. This is a lightweight container that *pretends* to be a complex AI (it accepts JSON and returns a rating), allowing us to teach the architecture without the overhead.

Here is the plan for Lecture 12.
