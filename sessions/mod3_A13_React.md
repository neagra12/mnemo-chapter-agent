# Session for the A13 (known as A17 to clio) - Reach Integration
...
That would be **Homework 12 (A17)**, the final major coding assignment. The goal is to complete the full decoupling of the frontend and backend by integrating a separate React application into the Docker stack to consume the API you just built.
