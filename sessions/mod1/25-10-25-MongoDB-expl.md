...
## ** ----- PROMPT ----- **
```markdown
We did not generate a TA guide for the MongoDB exploration challenge. This TA guide needs to reflect the workflow of the SAP. so they will need to wait for my analysis before evaluating the reflections. The guide should inform them how to use the analysis to evaluate the reflections according to our discussion of the SAP.
```

Here is the TA Guide for the "AI-Assisted Tech Evaluation (MongoDB)" challenge, built to follow the Standard Analysis Protocol (SAP) workflow.
...
| - Prompt is high-quality: provides project context (Flask,  |                 |
|   Users/Jokes) and is not just a generic question.  |                 |
\+-------------------------------------------------------------+-----------------+
| **Part 2: Critical Analysis (4 pts)** | / 4             |
| - Includes the full, unedited AI response.                  |                 |
| - **(SAP COMPARED):** Student *critically analyzes* the AI   |                 |
|   response, identifying key trade-offs the AI missed        |                 |
...
| - Uses the specific trade-offs from their Part 2 analysis to|                 |
|   professionally justify their decision.                    |                 |
\+-------------------------------------------------------------+-----------------+
| **Total** | \*\* / 10\*\* |
\+-------------------------------------------------------------+-----------------+
...
```html
<table style="width: 100%; border-collapse: collapse; border: 1px solid #ccc;" summary="Grading rubric for MongoDB Challenge">
    ...
    <tbody>
        <tr style="background-color: #f9f9f9;">
            <td style="padding: 12px; border: 1px solid #ccc; vertical-align: top;">
                <strong>Part 1: AI Prompt Engineering (3 pts)</strong>
                <ul style="margin-top: 5px; margin-bottom: 5px; padding-left: 20px;">
                    <li>Includes the full, unedited AI prompt.</li>
                    <li>Prompt provides good context (Flask, Users/Jokes) and is not just a generic question.</li>
                </ul>
            </td>
        ...
        <tr>
            <td style="padding: 12px; border: 1px solid #ccc; vertical-align: top;">
                <strong>Part 2: Critical Analysis (4 pts)</strong>
                <ul style="margin-top: 5px; margin-bottom: 5px; padding-left: 20px;">
                    <li>Includes the full, unedited AI response.</li>
                    <li><strong>(SAP COMPARED):</strong> Student <em>critically analyzes</em> the AI response, identifying key trade-offs the AI missed (as seen in the Instructor Exemplar and Lec 3, Slide 6).</li>
                </ul>
            </td>
        ...
        <tr style="background-color: #f9f9f9;">
            <td style="padding: 12px; border: 1px solid #ccc; vertical-align: top;">
                <strong>Part 3: Final Recommendation (3 pts)</strong>
                <ul style="margin-top: 5px; margin-bottom: 5px; padding-left: 20px;">
                    <li>Provides a clear, decisive recommendation (SQL or NoSQL).</li>
                    <li>Uses the specific trade-offs from their Part 2 analysis to justify the decision.</li>
                </ul>
            </td>
            <td style="padding: 12px; border: 1px solid #ccc; text-align: right; vertical-align: top;">/ 3</td>
        </tr>
