# Session for assignment for ICE11 (A15 to Clio) - Improve Dockerfile
...
Here is the full write-up for **Homework 10 (mod3\_A15)**.

This assignment bridges the gap between "it runs in Docker" (ICE 15) and "it is ready for deployment." It focuses on automation, optimization, and handling the "race conditions" that occur in real distributed systems.
