# Session for lecture 13 - Integrating React
...
Here is the plan for **Lecture 13**, the final concepts lecture that shifts the application architecture to be API-first.
