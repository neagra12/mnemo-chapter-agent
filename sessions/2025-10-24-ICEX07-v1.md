Here are the updated, separated, and standardized artifacts for **ICE 7**, based on the file you provided and all of our new workflow decisions.

-----

### 1\. Student-Facing Artifact

**File:** `cmod/student_facing/02_ices/ICE_07_Models_Migrations.md`
...
### 2. Instructor-Facing Artifact (TA Guide)

**File:** `cmod/instructor_facing/02_ta_guides/TA_Guide_ICE_07.md`
...
### 3\. Canvas-Optimized HTML Rubric Snippet

(Paste this snippet into the Canvas RCE's HTML view `</>`)
